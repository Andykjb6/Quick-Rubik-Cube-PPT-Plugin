...
namespace 课件帮PPT助手
{
    partial class Ribbon1 : Microsoft.Office.Tools.Ribbon.RibbonBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.计时器 = this.Factory.CreateRibbonButton();
            ...
            this.group6.Items.Add(this.计时器);
    ...
    "选中与它相同线条类型（如虚线、实线）的所有对象。";
            ...
            this.计时器.Label = "计时器";
            this.计时器.Name = "计时器";
            this.计时器.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.计时器_Click);
            // 
            // Ribbon1
            // 
            this.Name = "Ribbon1";
