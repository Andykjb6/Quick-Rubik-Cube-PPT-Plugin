...
namespace 课件帮PPT助手
{
    partial class Ribbon1 : Microsoft.Office.Tools.Ribbon.RibbonBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.匹配对齐 = this.Factory.CreateRibbonButton();
            ...
            this.课件帮PPT助手.Groups.Add(this.选择);
            ...
            this.group4.Items.Add(this.分组对齐);
            this.group4.Items.Add(this.匹配对齐);
            ...
            this.button4.ScreenTip = "使用说明：";
            this.button4.ShowImage = true;
            this.button4.SuperTip = "在文本框内选中一个完整拼音字母，单击“便捷注音”可为其注音。该工具可以悬停在PPT上，实现连续注音。当窗口没有关闭时进行连续注音，需点击刷新。";
            ...
            this.button8.ScreenTip = "使用说明：";
            this.button8.ShowImage = true;
            this.button8.SuperTip = "在弹出的窗口输入想要查询的汉字（仅支持单个输入），即可获取对应的笔顺SVG矢量图。（需联网）";
            ...
            this.button9.ScreenTip = "使用说明：";
            this.button9.ShowImage = true;
            this.button9.SuperTip = "自定义行列数，一键插入矩阵排列的生字格。";
            ...
            this.button2.SuperTip = "选中多张图片，以选中的第一张图片的宽高和比例为参考，统一后面选中的所有图片大小。";
            ...
            this.Masking.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.Masking_Click);
            // 
            // Gradientrectangle
            // 
    ...
    "°，按住Ctrl键单击则插入的蒙版渐变角度为90°；按住Shfit键单间则插入的蒙版渐变角度为45°。";
            ...
            // 匹配对齐
            // 
            this.匹配对齐.Image = ((System.Drawing.Image)(resources.GetObject("匹配对齐.Image")));
            this.匹配对齐.Label = "匹配对齐";
            this.匹配对齐.Name = "匹配对齐";
            this.匹配对齐.ShowImage = true;
            this.匹配对齐.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.匹配对齐_Click);
            // 
            // Mosaic
            // 
            this.Mosaic.Label = "";
            ...
            this.button14.ScreenTip = "使用说明：";
            this.button14.ShowImage = true;
            this.button14.SuperTip = "选中多个对象，以第一个被选中的对象为基准，从左到右保持一定距离排列（默认间距为10）。";
            this.button14.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.button14_Click);
            // 
            // button15
            // 
            this.button15.Image = ((System.Drawing.Image)(resources.GetObject("button15.Image")));
            this.button15.Label = "垂直分布";
            this.button15.Name = "button15";
            this.button15.ScreenTip = "使用说明：";
            this.button15.ShowImage = true;
            this.button15.SuperTip = "选中多个对象，以第一个被选中的对象为基准，从上往下保持一定距离排列（默认间距为10）。";
            ...
            this.Supercopy.Label = "原位复制";
            this.Supercopy.Name = "Supercopy";
            this.Supercopy.ShowImage = true;
            this.Supercopy.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.Supercopy_Click);
            // 
            // Pagecentered
            // 
            ...
            // Sizescaling
            // 
            this.Sizescaling.Image = ((System.Drawing.Image)(resources.GetObject("Sizescaling.Image")));
            this.Sizescaling.Label = "尺寸缩放";
            this.Sizescaling.Name = "Sizescaling";
            this.Sizescaling.ScreenTip = "使用说明：";
            this.Sizescaling.ShowImage = true;
            this.Sizescaling.SuperTip = "1.输入单个数值，所选对象缩放对应数值百分比；2.输入两个数值，中间用逗号分隔，则所选对象按照选择的顺序等差缩放。";
            this.Sizescaling.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.Sizescaling_Click);
            // 
            // button20
            // 
            ...
            this.button21.Label = "批量命名";
            this.button21.Name = "button21";
            this.button21.ScreenTip = "使用说明：";
    ...
    "同时选中与它相同线条类型（如虚线、实线）的所有对象。";
            ...
            this.replacetextbutton.Label = "批量换字";
            this.replacetextbutton.Name = "replacetextbutton";
            this.replacetextbutton.ScreenTip = "使用说明";
            this.replacetextbutton.ShowImage = true;
            this.replacetextbutton.SuperTip = "选中一个或多个文本框，一键批量替换多个文本框的内容。";
            this.replacetextbutton.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.replacetextbutton_Click);
            // 
            // Replaceimage
            // 
            ...
            this.button17.Label = "便捷抠图";
            this.button17.Name = "button17";
            this.button17.ScreenTip = "【实验功能】";
            this.button17.ShowImage = true;
            this.button17.SuperTip = "选中一张图片，单击载入抠图窗口，自动根据图片直方图信息调整阈值，一键去除背景。支持二次重置，调整参数。";
            ...
            this.button18.ScreenTip = "使用说明：";
            this.button18.ShowImage = true;
            this.button18.SuperTip = "使用便捷抠图会产生一些临时文件，在不用抠图时可进行清除。临时文件存储于系统临时文件夹内：C:\\Users\\Andy\\AppData\\Local\\Temp。";
            this.button18.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.button18_Click);
            // 
            // button19
            // 
            this.button19.Image = ((System.Drawing.Image)(resources.GetObject("button19.Image")));
            this.button19.Label = "在线抠图";
            ...
            // Fillblank
            // 
            this.Fillblank.Image = ((System.Drawing.Image)(resources.GetObject("Fillblank.Image")));
            this.Fillblank.Label = "挖词填空";
            this.Fillblank.Name = "Fillblank";
            this.Fillblank.ScreenTip = "使用说明：";
            this.Fillblank.ShowImage = true;
            this.Fillblank.SuperTip = "在文本框内选中一个字词，单击此处可一键挖词填空。（字词可能存在错位）";
            this.Fillblank.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.Fillblank_Click_1);
            // 
            // Timer
            // 
            ...
            // Boardpasting
            // 
            this.Boardpasting.Image = ((System.Drawing.Image)(resources.GetObject("Boardpasting.Image")));
            this.Boardpasting.Label = "板贴辅助";
            this.Boardpasting.Name = "Boardpasting";
            this.Boardpasting.ScreenTip = "使用说明：";
            this.Boardpasting.ShowImage = true;
            this.Boardpasting.SuperTip = "选中已设定好的文本样式（如云朵字），单击“板贴辅助”，可手动输入多行的分行文本（每个词语回车换行），则一键套用选中的板贴样式并根据分行文本数量创建多页板贴。按住C" +
    "trl键，单击“板贴辅助”，则支持导入txt格式的分行文本进行批量创建。";
        ...
        internal RibbonButton Boardpasting;
        ...
        internal RibbonButton Supercopy;
        internal RibbonButton Pagecentered;
        internal RibbonButton Sizescaling;
